...
Tabela poniżej przedstawia a summary of the 2017 Top 10 Application Security Risks, and the risk factors we have assigned to each risk. These factors were determined based on the available statistics and the experience of the OWASP Top 10 team. Aby zrozumieć te ryzyka w świetle określonej aplikacji lub organizacji - musisz przeanalizować (consider) (your own specific threat agents and business impacts). Even severe software weaknesses may not present a serious risk if there are no threat agents in a position to perform the necessary attack or the business impact is negligible for the assets involved.

![Risk Factor Table](images/0xc1-risk-factor-table.png)

## Dodatkowe ryzyka to rozważenia/ uwzględnienia (consider)
